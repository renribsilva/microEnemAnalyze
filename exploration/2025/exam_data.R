...
# Importa os scores
data <- data.table::fread("exploration/2025/MICRODADOS/score_lc.csv")

path_json <- as.character(
  file.path(
    "~/Área\ de\ trabalho/DEV/NEXT/microenem",
    "src/app/(home)/JSON/2025/dificuldade-do-exame/LC/"
  )
)
...
# Importa os scores
data <- data.table::fread("exploration/2025/MICRODADOS/score_ch.csv")

path_json <- as.character(
  file.path(
    "~/Área\ de\ trabalho/DEV/NEXT/microenem",
    "src/app/(home)/JSON/2025/dificuldade-do-exame/CH/"
  )
)
...
# Importa os scores
data <- data.table::fread("exploration/2025/MICRODADOS/score_cn.csv")

path_json <- as.character(
  file.path(
    "~/Área\ de\ trabalho/DEV/NEXT/microenem",
    "src/app/(home)/JSON/2025/dificuldade-do-exame/CN/"
  )
)
...
# Importa os scores
data <- data.table::fread("exploration/2025/MICRODADOS/score_mt.csv")

path_json <- as.character(
  file.path(
    "~/Área\ de\ trabalho/DEV/NEXT/microenem",
    "src/app/(home)/JSON/2025/dificuldade-do-exame/MT/"
  )
)
