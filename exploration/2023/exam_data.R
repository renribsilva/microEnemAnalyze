...
# Importa os scores
data <- data.table::fread("exploration/2023/MICRODADOS/score_lc.csv")
...
# Importa os scores
data <- data.table::fread("exploration/2023/MICRODADOS/score_ch.csv")
...
# Importa os scores
data <- data.table::fread("exploration/2023/MICRODADOS/score_cn.csv")
...
# Importa os scores
data <- data.table::fread("exploration/2023/MICRODADOS/score_mt.csv")
