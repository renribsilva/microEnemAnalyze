...
path_json <- as.character("~/Área\ de\ trabalho/DEV/NEXT/microenem/src/app/(home)/JSON/2024/")
...
write_itens(path_json = path_json, ano = 2024)

# Escreve json de dic
write_dic(path_json = path_json, ano = 2024)

# Escreve o traço de probabilidade
write_probtrace(path_json = path_json, ano = 2024)

# Escreve o traço de informação
write_iteminfo(path_json = path_json, ano = 2024)
