...
path_csv <- as.character("exploration/2024/MICRODADOS/at_least_one_presence.csv")
...
# Importa os microdados
# table <- fread("exploration/2024/MICRODADOS/microdados_enem_2024/DADOS/MICRODADOS_ENEM_2024.csv")

# Caminho para gravar o csv
# path_csv <- as.character("exploration/2024/MICRODADOS/at_least_one_presence_nt.csv")
...
write_score(data, path_csv = path_csv, ano = 2024)
