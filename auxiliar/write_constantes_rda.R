...
res_lc <- process_constantes(sample_lc, "LC")
res_ch <- process_constantes(sample_ch, "CH")
res_cn <- process_constantes(sample_cn, "CN")
res_mt <- process_constantes(sample_mt, "MT")
