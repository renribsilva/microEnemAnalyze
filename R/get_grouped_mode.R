...
#'
#' @description Esta função calcula a estimativa da moda para
#' variáveis contínuas utilizando o método de agrupamento em
#' classes. É especialmente útil para distribuições de notas
#' (como as do ENEM), onde a moda empírica simples pode ser
#' ruidosa. A estimativa tende a coincidir com o pico da curva
#' de densidade kernel.
#'
#' @param x Vetor numérico contendo os dados brutos (ex: notas).
#' @param bin_width Numérico. A largura do intervalo
#' (classe) para o agrupamento. O padrão é 10 (recomendado
#' para escalas de 0 a 1000).
#'
#' @return Um valor numérico representando a moda estimada.
#'
#' @details
#' A fórmula de Czuber considera as frequências das classes
#' adjacentes à classe modal:
